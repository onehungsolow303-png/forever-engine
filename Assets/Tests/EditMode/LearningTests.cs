...
namespace ForeverEngine.Tests
{
    public class LearningTests
    {
        ...
        [Test] public void ReinforcementLearner_TracksEpisodes() { var rl = new ReinforcementLearner(4, 3); rl.Step(0, 1, 1f, 1, false); rl.Step(1, 0, 2f, 0, true); Assert.AreEqual(1, rl.Episodes); }
    }
}
